...
public class EmojiHolder implements Serializable {
    ...
    static {
        ...
        emojiMap.put("[污]", R.drawable.d_wu);
        ...
        emojiMap.put("[加油]", R.drawable.h_jiayou);
        ...
        emojiMap.put("[月亮]", R.drawable.w_yueliang);
        emojiMap.put("[狂躁症]", R.drawable.kuangzaozheng);
        ...
        emojiMap.put("[得意的笑]", R.drawable.lxh_deyidexiao);
        ...
        emojiMap.put("[扣鼻屎]", R.drawable.lxh_koubishi);
    ...
    public static int getEmojiIcon(String emojiString) {
        Integer integer = emojiMap.get(emojiString);
        if(integer != null) {
            return integer;
        }
        return 0;
